...
exports.connect = async() => {
    ...
    samu330.on('connecting', () => {
        console.log(chalk.whiteBright("⌛"), chalk.keyword("red")("□ Estado de TselyBot"), chalk.keyword("aqua")("Connecting..."))
    })
        samu330.on('open', () => {
        ...
        console.log(chalk.keyword("green")("│"), chalk.keyword("red")('│'), chalk.keyword("magenta")(' Samu330 | MankBarBar | Rooz '))
        console.log(chalk.keyword("green")("│"), chalk.keyword("red")('╰╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╯'))
