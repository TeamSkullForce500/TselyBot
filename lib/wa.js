...
exports.sendFakeStatus2 = (from, teks) => {
        samu330.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '☠️ Team SkullForce 500 ☠️ | TselyBot', "jpegThumbnail": fs.readFileSync(`./src/fake.jpg`)} } } })
}
                ...
                message: {
                        "productMessage": {
                                "product": {
                                        ...
                                        "title": '☠️ Team SkullForce 500 ☠️ | TselyBot',
                                        "description": "Tsely-chan",
                                        "currencyCode": "SYP",
